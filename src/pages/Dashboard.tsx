  ...
  return (
    <DashboardLayout>
      <div className="w-full">
        ...
        <div className="grid gap-3 sm:gap-4 grid-cols-2 sm:grid-cols-4 mb-3 sm:mb-4">
          <MetricCard 
              ...
              {lists.length === 0 ? (
                ...
                <div className="rounded-md border">
                  <Table>
                    <TableHeader>
                      <TableRow>
                        <TableHead className={isMobile ? "py-2 px-3" : ""}>
                    ...
                    <TableBody>
                      {lists
                        ...
                        .map(list => (
                          ...
                          >
                            <TableCell className={`font-medium ${isMobile ? "py-2 px-3" : ""}`}>
                              {list.title}
                            </TableCell>

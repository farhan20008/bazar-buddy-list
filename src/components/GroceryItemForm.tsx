...
export function GroceryItemForm({ listId, item, onSubmit }: GroceryItemFormProps) {
  const { addItemToList, updateItemInList, generatePriceSuggestion } = useGrocery();
  ...
  const handleGeneratePrice = async () => {
    ...
    try {
      ...
      const price = await generatePriceSuggestion(
        name,
